...
init python:
    register_stat("Monique", "strength", 100, 100)
    register_stat("Julie", "intelligence", 80, 80)
    register_stat("Preston", "relaxation", 60, 60)

    dp_period("Monique", "morning_act")
    dp_choice("Focused Studies", "class")
    dp_choice("Calm Attention", "cut")
    dp_choice("Socializing", "class1")
    dp_choice("Daydreaming", "class2")
    dp_choice("Indifference", "class3")
    dp_choice("Intense Research", "class4")
    dp_choice("Lend a Hand", "class5")
    ...
    dp_period("Preston", "afternoon_act")
    dp_choice("Focused Studies", "class")
    dp_choice("Calm Attention", "cut")
    dp_choice("Socializing", "class1")
    dp_choice("Daydreaming", "class2")
    dp_choice("Indifference", "class3")
    dp_choice("Reading Comics", "class4")
    dp_choice("Storywriting", "class5")
    
    dp_period("Julie", "evening_act")
    dp_choice("Focused Studies", "class")
    dp_choice("Calm Attention", "cut")
    dp_choice("Socializing", "class1")
    dp_choice("Daydreaming", "class2")
    dp_choice("Indifference", "class3")
    dp_choice("Creating Artwork", "class4")
    dp_choice("Web Browsing", "class5")
...
label day:
    ...
    $ afternoon_act = None
    $ evening_act = None
    $ narrator("\n\nWhat are the goals of today?", interact=False)
    window show
